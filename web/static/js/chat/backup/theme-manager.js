...
const ThemeManager = (function() {
    ...
    function initialize() {
        ...
        if (!existingToggle) {
            console.log('🎨 ThemeManager: Creating new theme toggle button');
            createThemeToggle();
        } else {
            console.log('🎨 ThemeManager: Using existing theme toggle button');
            themeToggleButton = existingToggle;
            setupEventListeners();
        }
    ...
    function createThemeToggle() {
        ...
        themeToggleButton.setAttribute('title', 'Toggle light/dark mode');
        
        // Update the icon based on current theme
        updateToggleIcon();
        
        // Add to the page - we'll place it in the header or nav if available
        const targetLocation = document.querySelector('.chat-header') || 
                              document.querySelector('.navbar') || 
                              document.querySelector('header');
        
        if (targetLocation) {
            if (targetLocation.classList.contains('chat-header')) {
                // For chat header, add as a control
                themeToggleButton.classList.add('chat-control');
                targetLocation.appendChild(themeToggleButton);
            } else {
                // For navbar/header, add at the end
            ...
            // Fallback - create a floating button at top right
            themeToggleButton.classList.add('floating-theme-toggle');
