...
try:
    ...
    logger.warning("Memory system not available - some functionality will be limited")
...
try:
    ...
    logger.warning("Feedback system not available - some functionality will be limited")
