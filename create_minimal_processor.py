...
def create_minimal_processor():
    """Create a minimal version of multi_model_processor.py with essential functions."""
    
    file_path = "/Users/bendickinson/Desktop/Minerva/web/multi_model_processor_minimal.py"
    
    # Create the minimal version with only essential functions
...
"""
    ...
    print(f"Created minimal processor at {file_path}")
